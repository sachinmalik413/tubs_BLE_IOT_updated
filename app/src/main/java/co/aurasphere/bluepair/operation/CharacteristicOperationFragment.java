...
public class CharacteristicOperationFragment extends Fragment {
    ...
    private static final String TAG = CharacteristicOperationFragment.class.getSimpleName();
            ...
            switch (charaProp) {
                ...
                case PROPERTY_WRITE: {
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            String hex = toHex(et.getText().toString());
                            if (TextUtils.isEmpty(hex)) {
                                return;
                            }
                            Log.e(TAG, "onClick: write uuid "+characteristic.getService().getUuid().toString());
                            Log.e(TAG, "onClick: read uuid "+characteristic.getUuid().toString());
